    ...
    function createMessageChoose(tree, selectContent, selectId){
        for(var index in tree){
            ...
            for(var i = 0; i < currentLevel; i++){
                intentStr += "<span class='intent'>&emsp;</span>";
            }

            var innerHtml = "<div onclick='treeControl(this,\"" + selectContent + "\",\"" + selectId +"\")' status='" + status + "' tree-level='"  
            	+ currentLevel + "' class='treeLevel level" + currentLevel + "' targetContent='" + tree[index].text + "' hasChild='" + hasChild 
            	+"' targetId='" + tree[index].id + "'>" + intentStr + iconClass +  "<span class='treeContent'>" + tree[index].text +"</span></div>";
