...
<head>
<style type="text/css">
    #classroomManageCreate>div{
        margin-bottom: 10px;
        text-align:left;
        margin-left: 100px;
    }
    #classroomManageCreate .dataName{
        display: inline-block;
        width: 110px;
         text-align:right;
    }
    #classroomManageCreate input.form-control,
    #classroomManageCreate select.form-control{
        width: 200px;
    }
    #classroomManageCreate .text-btn-group input.form-control {
        width: 450px;
    }
    #classroomManageCreate textarea.form-control {
        width: 450px;
        display: inline-block;
    }
    #classroomManageCreate #createPop{
        display: none;
        width: 100%;
        position: fixed;
        z-index: 10001;
