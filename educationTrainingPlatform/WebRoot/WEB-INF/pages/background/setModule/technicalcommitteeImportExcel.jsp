...
<head>
<style type="text/css">
    #technicalcommitteeManageExcel>div{
        margin-bottom: 10px;
        text-align:left;
        margin-left: 100px;
    }
    #technicalcommitteeManageExcel .dataName{
        display: inline-block;
        width: 110px;
         text-align:right;
    }
    #technicalcommitteeManageExcel input.form-control,
    #technicalcommitteeManageExcel select.form-control{
        width: 200px;
    }
    #technicalcommitteeManageExcel .text-btn-group input.form-control {
        width: 450px;
    }
    #technicalcommitteeManageExcel textarea.form-control {
        width: 450px;
        display: inline-block;
    }
    #technicalcommitteeManageExcel #createPop{
        display: none;
        width: 100%;
        position: fixed;
        z-index: 10001;
...
<body>
<div id="technicalcommitteeManageExcel">
