    ...
    <div class="search-div">
        <div class="search-div">
            ...
            <div class="text-btn-group">
                <input id="fatherOrganization" type="text" class="form-control" />
                <button class="btn btn-xs btn-primary  glyphicon glyphicon-search"
                        onclick="popOrganizationManageModal('${path}/background/organizationManageChoose.html', '父組織', 'search-choose')">
                </button>
            </div>&emsp;
            是否有效：
        ...
        <div class="search-div">
            ...
            <button class="btn btn-xs btn-primary" onclick="popOrganizationManageModal('${path}/background/organizationManageCreate.html', '新增組織管理', 'create')">
                <b class="glyphicon glyphicon-plus-sign"></b>&nbsp;新增
            </button>
            <button class="btn btn-xs btn-primary" onclick="popOrganizationManageModal('${path}/background/organizationManageModify.html', '修改組織管理', 'modify')">
...
<script type="text/javascript">
	$("#organizationManageModal #commit").click(function(){
		$("#fatherOrganization").val($("#selectContent").val());
		$("#organizationManageModal").modal("hide");
	});
