...
<head>
<style type="text/css">
    #technicalcommitteeManageCreate>div{
        margin-bottom: 10px;
        text-align:left;
        margin-left: 100px;
    }
    #technicalcommitteeManageCreate .dataName{
        display: inline-block;
        width: 110px;
         text-align:right;
    }
    #technicalcommitteeManageCreate input.form-control,
    #technicalcommitteeManageCreate select.form-control{
        width: 200px;
    }
    #technicalcommitteeManageCreate .text-btn-group input.form-control {
        width: 450px;
    }
    #technicalcommitteeManageCreate textarea.form-control {
        width: 450px;
        display: inline-block;
    }
    #technicalcommitteeManageCreate #createPop{
        display: none;
        width: 100%;
        position: fixed;
        z-index: 10001;
...
<body>
<div id="technicalcommitteeManageCreate">
	${requestScope.testData }
    <div id="shade"></div>
    <div>
    <span class="dataName">技委會代碼<font color="red">*</font>：</span> 
    <input type="text" class="form-control"/>
          </div>
            <div>
              <span class="dataName">技委會名稱<font color="red">*</font>：</span> 
     <input type="text" class="form-control"/>
     </div>
